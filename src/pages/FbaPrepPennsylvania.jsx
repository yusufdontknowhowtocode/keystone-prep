...
export default function FbaPrepPennsylvania() {
  useEffect(() => {
    document.title =
      'FBA Prep Center in Pennsylvania — Keystone Prep, Lansdale PA'
    ...
    if (desc) {
      desc.setAttribute(
        'content',
        'Pennsylvania FBA prep center in Lansdale, PA — dock-high receiving, 48-ft trailer access, FNSKU labeling, polybagging, bundling, and storage. $0.55–$0.65/unit all-in. Minutes from the PA Amazon FC corridor.'
      )
    }
    ...
    canonical.setAttribute(
      'href',
      'https://keystoneprepcenter.com/fba-prep-pennsylvania'
    )
  }, [])
      ...
      <main>
        <section className="max-w-4xl mx-auto px-4 py-14 md:py-20">
          ...
          <p className="text-lg pp-sub mt-6">
            Keystone Prep runs Amazon FBA prep and 3PL out of a 6,000 sq ft
            staffed warehouse in Lansdale, Pennsylvania — elevated dock at
            trailer height, a lot that takes full 48-foot containers, and
            racked client storage. Pennsylvania sits in the middle of the East
            Coast&apos;s Amazon fulfillment corridor, so inventory prepped here
            reaches FCs in the Lehigh Valley, Hazleton, and Carlisle fast and
            cheap.
          </p>

          <p className="text-lg pp-sub mt-4">
            Send a container or a single case. Every carton is photographed at
            receiving, every unit is tracked live in your client portal, and
            outbound shipments wait for your approval before anything leaves
            the building.
          </p>
        ...
        <section className="max-w-4xl mx-auto px-4 py-12">
          <h2 className="pp-display text-4xl font-bold uppercase">
            Pennsylvania FBA prep pricing
          </h2>

          <p className="pp-sub mt-3">
            One all-in rate per unit — receiving, inspection, FNSKU label, and
            box prep. No setup fees, no minimums, no contracts.
          </p>
          ...
          <p className="text-sm pp-sub mt-3">
            ...
            wrap $0.40/unit, bundling $0.50 per unit bundled, pallet storage
            $25/pallet/mo. Your first test shipment — up to 100 units — is on
          ...
          <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mt-6 text-sm">
              {[
                [
                  'Dock-high receiving',
                  'Elevated dock at standard trailer height',
                ],
                [
                  '48-ft trailer access',
                  'Open paved lot with room to maneuver full containers',
                ],
                [
                  '6,000 sq ft',
                  'Racked storage with separated client zones',
                ],
                [
                  'Receiving 9–5 Mon–Fri',
                  'Parcel, LTL, and container freight accepted',
                ],
              ].map(([title, sub]) => (
                <div key={title} className="pp-card px-4 py-3">
                  <div className="font-semibold flex items-center gap-2">
                    <Warehouse size={16} className="pp-accent" />
                    {title}
                  </div>
            ...
            <p className="text-sm pp-sub mt-4">
              Keystone operates out of the U.S. facility of KT Trims, an
              apparel-trim manufacturer supplying major global fashion brands
              — a receiving crew with years of international container
              experience handles your freight.{' '}
              Importing by the container? See our{' '}
              <a
                href="/container-receiving"
                className="underline"
                style={{ color: 'var(--ink)' }}
              >
                container receiving
        ...
        >
          <div className="max-w-4xl mx-auto px-4 py-12 text-center">
            <h2 className="pp-display text-4xl md:text-5xl font-bold uppercase">
              Get a Pennsylvania prep rate in seconds.
            </h2>

            <p className="pp-sub mt-3 max-w-xl mx-auto">
              Use the estimator on our homepage for an instant number, or
              message us directly — we reply fast, seven days a week.
            </p>
